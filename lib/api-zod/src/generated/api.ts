...
export const RegisterResponse = zod.object({
  ...
  "username": zod.string(),
  "email": zod.string(),
  "role": zod.enum(['user', 'meril', 'moderator', 'creator', 'verified_creator', 'admin', 'owner']),
  ...
  "creatorBadge": zod.boolean().optional(),
  "verifiedCreator": zod.boolean().optional(),
...
export const CreateAutomaticTopupResponse = zod.object({
  ...
  "orderId": zod.string(),
  "amount": zod.number(),
  "status": zod.enum(['pending', 'awaiting_confirmation', 'paid', 'confirmed', 'expired', 'failed', 'cancelled']),
